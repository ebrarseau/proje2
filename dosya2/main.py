...
insan1 = Insan(12378965456,"Fatih","Demir","36","Erkek","Turk")
insan2 = Insan(45672318942,"Buket","Gulubay","33","Kadin","Turk")
print(insan1)
print(insan2)
print("\n")

issiz1 = Issiz(14563287496,"Meliha","Smajlovic","48","Kadin","Alman",{ "mavi yaka": 5, "beyaz yaka": 4, "yonetici": 0 })
issiz2 = Issiz(96385214714,"Ahmet","Yel","33","Erkek","Turk",{ "mavi yaka": 0, "beyaz yaka": 4, "yonetici": 3 })
issiz3 = Issiz(75315984256,"Kadir","Selim","30","Erkek","Turk",{ "mavi yaka": 7, "beyaz yaka": 4, "yonetici": 0})
print(issiz1)
print(issiz2)
print(issiz3)
print("\n")

calisan1 = Calisan(15632478645,"Thomas","Jaechke","33","Erkek","Amerikan","muhasebe",48,13000)
calisan2= Calisan(78645865214,"Nihal","Yilmaz","36","Kadin","Turk","diger",12,12200)
calisan3 = Calisan(78645898542,"Sude","Yuce","36","Kadin","Turk","teknoloji",60,23000)
print(calisan1)
print(calisan2)
print(calisan3)
print("\n")

maviyaka1 = MaviYaka(84286235415,"Melih","Gereksiz","30","Erkek","Turk","insaat",48,13000,0.8)
maviyaka2 = MaviYaka(45875325841,"Thomas","Enderson","27","Erkek","Ingiliz","teknoloji",24,10000,0.5)
maviyaka3 = MaviYaka(34675414852,"Yigit","Kara","34","Erkek","Türk","muhasebe",60,16000,0.6)
print(maviyaka1)
print(maviyaka2)
print(maviyaka3)
print("\n")

beyazyaka1= BeyazYaka(12378965414,"Kerim","Yuksel","23","Erkek","Turk","diger",0,10000,1000)
beyazyaka2 = BeyazYaka(12475395145,"Naz","Aydemir","27","Kadin","Turk","diger",36,12000,2000)
beyazyaka3 = BeyazYaka(74563258265,"Arina","Tseva","30","Kadin","Fransiz","teknoloji",60,20000,2500)
print(beyazyaka1)
print(beyazyaka2)
print(beyazyaka3)
print("\n")
